...
public class PathlessAutoTest extends SequentialCommandGroup {
  /** Creates a new PathlessAutoTest. */
  public PathlessAutoTest(Shooter shooter, Drive drivetrain, Intake intake, Vision vision) {
