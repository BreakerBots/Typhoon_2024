...
public class ShootManualFloat extends SequentialCommandGroup {
  /** Creates a new ShootManualAllign. */
  public ShootManualFloat(Shooter shooter) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(
      new InstantCommand(() -> shooter.setActiveTarget(Constants.ShooterConstants.FLOAT_SHOT_SUPPLIER), shooter),
