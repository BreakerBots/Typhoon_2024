...
public class HandoffFromShooterToIntake extends SequentialCommandGroup {
  ...
  public HandoffFromShooterToIntake(Shooter shooter, Intake intake, boolean retractAtEnd) {
    ...
    addCommands(
        ...
        new WaitUntilCommndWithFallingEdgeDelayAndTimeout(intake::hasNote, 0.5, 2.5),
