...
public class StationaryPassNoteFromAnywhere extends SequentialCommandGroup {
  /** Creates a new StationaryPassNoteFromAnywhere. */
   public StationaryPassNoteFromAnywhere(Shooter shooter, Drive drive) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(
      new InstantCommand(() -> shooter.setActiveTarget(RobotContainer.PASS_TARGET::getFireingSolution)),
