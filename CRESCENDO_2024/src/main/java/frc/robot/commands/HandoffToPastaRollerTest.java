...
public class HandoffToPastaRollerTest extends SequentialCommandGroup {
  /** Creates a new HandoffToPastaRollerTest. */
  public HandoffToPastaRollerTest(Intake intake, PastaRoller pastaRoller) {
    ...
    addCommands(
      ...
      new WaitUntilCommndWithFallingEdgeDelayAndTimeout(() ->{return !intake.hasNote();}, 2.5, 5.0),
