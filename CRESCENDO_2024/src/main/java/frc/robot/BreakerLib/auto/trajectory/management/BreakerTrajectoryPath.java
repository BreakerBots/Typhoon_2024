...
/**
 * Represents a trajectory and its optionally attached
 * {@link BreakerConditionalEvent} instnaces
 */
public class BreakerTrajectoryPath {
    ...
    /**
     * Creates a new {@link BreakerTrajectoryPath} that stops the robot when
     * finished and has
     ...
     * 
     * @param baseTrajectory    The {@link Trajectory} this path represnets
     * @param conditionalEvents An array of {@link BreakerConditionalEvent}
     *                          instances attached to this path
     */
    ...
    /**
     * Creates a new {@link BreakerTrajectoryPath} that has no attached
     * {@link BreakerConditionalEvent} instances
     * 
     * @param baseTrajectory The {@link Trajectory} this path represents.
     * @param stopAtEnd      A boolean represeting wheather or not this path stops
     *                       the robot when finished.
     */
     ...
     * 
     * @param baseTrajectory    The {@link Trajectory} this path represnets
     * @param stopAtEnd         A boolean represeting wheather or not this path
     *                          stops the robot when finished
     * @param conditionalEvents An array of {@link BreakerConditionalEvent}
     *                          instances attached to this path
     */
    public BreakerTrajectoryPath(Trajectory baseTrajectory, boolean stopAtEnd,
            BreakerConditionalEvent... conditionalEvents) {
        this.baseTrajectory = baseTrajectory;
        this.stopAtEnd = stopAtEnd;
